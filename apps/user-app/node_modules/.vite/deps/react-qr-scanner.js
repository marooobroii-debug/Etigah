...
// node_modules/react-qr-scanner/dist/react-qr-scanner.esm.js
...
if (true) {
  ReactPropTypesSecret$2 = ReactPropTypesSecret_1;
  loggedTypeFailures = {};
  has$1 = has$2;
...
var stopMediaStream = function stopMediaStream2(stream) {
  if (stream) {
...
var Reader = function Reader2(props) {
  var constraints = props.constraints, onError = props.onError, onLoad = props.onLoad, onScan = props.onScan, resolution = props.resolution, qrArea = props.qrArea, other = _objectWithoutProperties(props, _excluded);
  var streamRef = React.useRef(null);
  var videoEl = React.useRef(null);
  var canvasEl = React.useRef(document.createElement("canvas"));
  var ctxRef = React.useRef(null);
  var requestRef = React.useRef();
  var _React$useState = React.useState(null), _React$useState2 = _slicedToArray(_React$useState, 2), src = _React$useState2[0], setSrc = _React$useState2[1];
  ...
  React.useEffect(function() {
    ...
    worker.onmessage = function(e2) {
      if (onScan) onScan(e2.data ? _objectSpread(_objectSpread({}, e2.data), {}, {
  ...
  var check = React.useCallback(function() {
    var qrArea2 = JSON.parse(qrAreaStr);
    var worker = workerRef.current;
    ...
    if (!isProcessingRef.current && videoIsPlaying) {
      ...
      var imageData;
      if (qrArea2 && qrArea2.length === 2 && qrArea2[0] > 0 && qrArea2[1] > 0) {
        imageData = ctxRef.current.getImageData(Math.floor((width - qrArea2[0]) / 2), Math.floor((height - qrArea2[1]) / 2), qrArea2[0], qrArea2[1]);
      } else {
  ...
  React.useEffect(function() {
    var constraints2 = JSON.parse(constraintsStr);
...
react-qr-scanner/dist/react-qr-scanner.esm.js:
  ...
  *)
*/
//# sourceMappingURL=react-qr-scanner.js.map
